...
// import * as Yup from 'yup';
// import { useAppDispatch } from '../hooks/redux';
// import { fetchWordMeaning, setCurrentWord, clearError, setCustomError } from '../store/dictionarySlice';
...
//         if (!/^[a-zA-Z]+$/.test(word)) {
//           // En lugar de mostrar el error en Formik, lo establecemos en el estado Redux
//           // para que se muestre usando el componente de error existente
//           dispatch(setCurrentWord(word));
//           dispatch(setCustomError('Please enter alphabetic characters only'));
//           return;
//         }
...
//         dispatch(fetchWordMeaning(word));
//       } else {
//         // Limpiar el estado cuando se envía un formulario vacío
//         dispatch(setCurrentWord(''));
//         dispatch(clearError());
//       }
//     },
...
//   const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
//     formik.handleChange(e);
//     // Si el campo está vacío, limpia el estado
//     if (e.target.value.trim() === '') {
//       dispatch(setCurrentWord(''));
//       dispatch(clearError());
//     }
    
//     // Cada vez que hay un cambio, mostrar el error si existe
//     setShowError(true);
...
//   // Cuando el campo pierde el foco, iniciar temporizador para ocultar el error
//   const handleBlur = (e: React.FocusEvent<HTMLInputElement>) => {
//     formik.handleBlur(e);
    
//     // Iniciar temporizador para ocultar el error después de 5 segundos
//     if (errorTimeoutRef.current) {
//       clearTimeout(errorTimeoutRef.current);
//     }
...
//   // Cuando el componente se desmonta, limpiar el temporizador
//   useEffect(() => {
//     return () => {
//       if (errorTimeoutRef.current) {
//         clearTimeout(errorTimeoutRef.current);
...
//   const handleSearchIconClick = (e: React.MouseEvent<HTMLButtonElement>) => {
//   // Si el campo está vacío, mostrar error al hacer clic en el icono
//   if (formik.values.word.trim() === '') {
//     e.preventDefault(); // Prevenir el submit del formulario
//     formik.setFieldTouched('word', true, true); // Marcar el campo como tocado
//     setShowError(true); // Mostrar el mensaje de error

//     // Reiniciar el temporizador para ocultar el error después de 5 segundos
//     if (errorTimeoutRef.current) {
//       clearTimeout(errorTimeoutRef.current);
//     }
