...
//   // Limpiar el error cuando se cambia de palabra o se limpia el formulario
//   useEffect(() => {
//     if (!currentWord || currentWord.trim() === '') {
//       dispatch(clearError());
//     }
...
//   // No mostrar nada si no hay palabra de búsqueda
//   if (!currentWord || currentWord.trim() === '') {
//     return null;
//   }
...
//   // Find first audio file that exists
//   const audioFile = data.phonetics.find(p => p.audio && p.audio.trim() !== '')?.audio || '';
...
//                focus:ring-purple focus:ring-opacity-50"
//               aria-label="Play pronunciation"
//             >
//               <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 75 75">
//                 <g fill="#A445ED" fillRule="evenodd">
//                   <circle cx="37.5" cy="37.5" r="37.5" opacity=".25"/>
//                   <path d="M29 27v21l21-10.5z"/>
//                 </g>
...
//         <div key={index} className="mt-8">
//           <div className="flex items-center gap-4">
//             <h2 className="text-xl italic font-bold">{meaning.partOfSpeech}</h2>
//             <hr className="flex-grow border-gray-200 dark:border-gray-400" />
//           </div>
          
//           <div className="mt-4">
//             <h3 className="text-gray-300 mb-2">Meaning</h3>
//             <ul className="list-disc list-outside pl-5 space-y-3">
//               {meaning.definitions.map((def, idx) => (
//                 <li key={idx} className="text-base">
//                   <p>{def.definition}</p>
//                   {def.example && (
//                     <p className="text-gray-300 mt-2">"{def.example}"</p>
//                   )}
//                 </li>
//               ))}
//             </ul>
...
//           {meaning.synonyms.length > 0 && (
//             <div className="mt-6 flex">
//               <h3 className="text-gray-300 mr-6">Synonyms</h3>
//               <div className="flex flex-wrap gap-2">
//                 {meaning.synonyms.map((synonym, idx) => (
//                   <span key={idx} className="text-purple font-bold hover:underline cursor-pointer transition-colors focus:outline-none focus:ring-2 focus:ring-purple focus:ring-opacity-50 focus:rounded px-1">
//                     {synonym}
//                   </span>
//                 ))}
//               </div>
...
//         <div className="mt-8 pt-4 border-t border-gray-200 dark:border-gray-400">
//           <div className="flex flex-wrap items-center gap-2">
//             <h3 className="text-gray-300 text-sm">Source</h3>
//             <a 
//               href={data.sourceUrls[0]} 
//               target="_blank" 
//               rel="noopener noreferrer"
...
//             >
//               {data.sourceUrls[0]}
//               <svg className="ml-2" width="14" height="14" viewBox="0 0 14 14">
//                 <path fill="none" stroke="#838383" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M6.09 3.545H2.456A1.455 1.455 0 0 0 1 5v6.545A1.455 1.455 0 0 0 2.455 13H9a1.455 1.455 0 0 0 1.455-1.455V7.91m-5.091.727 7.272-7.272m0 0H9m3.636 0V3.636"/>
//               </svg>
//             </a>
//           </div>
